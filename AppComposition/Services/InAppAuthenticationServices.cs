...
{
    public static class InAppAuthenticationServices
    {
        ...
        private static async Task AddUserDetailsToPreferencesAndSecureStorage(UserCredential userCredential)
        {
            ...
            Preferences.Default.Set("email", userCredential.User.Info.Email);
            Preferences.Default.Set("first_name", userCredential.User.Info.FirstName);
            Preferences.Default.Set("last_name", userCredential.User.Info.LastName);
            Preferences.Default.Set("display_name", userCredential.User.Info.DisplayName);
            Preferences.Default.Set("photo_url", userCredential.User.Info.PhotoUrl);
            Preferences.Default.Set("uid", userCredential.User.Info.Uid);
            Preferences.Default.Set("federated_id", userCredential.User.Info.FederatedId);
            Preferences.Default.Set("is_email_verified", userCredential.User.Info.IsEmailVerified);

            //Saving Credential info
            Preferences.Default.Set("provider_type", userCredential.User.Credential.ProviderType.ToString());
